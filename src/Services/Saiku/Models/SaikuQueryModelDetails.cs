...
{
    public class SaikuQueryModelDetails
    {
        [JsonPropertyName("axis")]
        public string Axis { get; set; } = "COLUMNS";
        [JsonPropertyName("location")]
        public string Location { get; set; } = "TOP";
        public SaikuQueryModelDetailsMeasure[] Measures { get; set; }
    }

    public class SaikuQueryModelDetailsMeasure
    {
