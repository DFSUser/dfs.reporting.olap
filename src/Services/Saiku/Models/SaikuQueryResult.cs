...
{
    public class SaikuQueryResult
    {
        [JsonPropertyName("cellset")]
        public SaikuCell[][] Cells { get; set; }
        [JsonPropertyName("rowTotalsLists")]
        public SaikuTotalItem[][] RowTotals { get; set; }
        [JsonPropertyName("colTotalsLists")]
        public SaikuTotalItem[][] ColumnTotals { get; set; }
    }
}
